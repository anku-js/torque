...
const initializeForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(isFormFieldsValid) {
      ...
      fetch("https://api.sheety.co/7ea08598bd4b3ce50248a7c8fe2ca9fb/torqueEngineeringLeads/sheet1", requestOptions)
      .then(response => {
        setFormSubmitted(true);
        setApiResponse("Thank you for your submission. We will get back to you soon.");
        setLoading(false);
      })
      .catch(error => {
        setFormSubmitted(true);
